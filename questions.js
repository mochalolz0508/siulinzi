...
window.QUESTION_BANK = {
  ...
  P3: {
    chi: [
      ...
      {t:"成語",q:['對症下','（針對問題想辦法）'],o:["藥","病","針","醫"],a:0,g:"對症下藥 💊",b:"對症下藥。"},
      {t:"近義詞",q:['「快」意思最接近……'],o:["迅速","緩慢","停止","休息"],a:0,g:"快 ≈ 迅速 💨",b:"快和迅速相近。"},
      {t:"反義詞",q:['「黑暗」的相反是……'],o:["光明","漆黑","陰沉","深夜"],a:0,g:"黑暗 ↔ 光明 💡",b:"黑暗的相反是光明。"},
      {t:"部首",q:['「湖」「海」都有甚麼部首？'],o:["氵(水)","古","每","月"],a:0,g:"都有水部氵 💧",b:"和水有關，用水部。"},
      {t:"量詞",q:['一','樹'],o:["棵","隻","朵","條"],a:0,g:"一棵樹 🌳",b:"樹用「棵」。"},
      {t:"標點",q:['心情很激動，句尾用……'],o:["。句號","？問號","！感嘆號","、頓號"],a:2,g:"激動用感嘆號 ！",b:"激動、驚嘆用感嘆號。"},
    ],
    eng: [
      ...
      {t:"Past tense",q:['She ___ happy yesterday.'],o:["was","is","are","were"],a:0,g:"She was happy",b:"She + was"},
      {t:"Comparative",q:['A mouse is ___ than a cat. 🐭🐱'],o:["small","smaller","smallest","more small"],a:1,g:"smaller than",b:"than → smaller"},
      {t:"Preposition",q:['The cat is ___ the table. 🐱⬇️'],o:["in","on","under","of"],a:2,g:"under the table",b:"below → under"},
      {t:"Vocabulary",q:['A place to buy food is a ___'],o:["supermarket","library","park","zoo"],a:0,g:"supermarket 🛒",b:"buy food → supermarket"},
      {t:"Question word",q:['___ are you sad? — I lost my toy.'],o:["Why","What","Who","Where"],a:0,g:"Why → reason",b:"reason → Why"},
      {t:"Plural",q:['one foot, two ___'],o:["foots","feet","foot","feets"],a:1,g:"foot → feet",b:"foot → feet (irregular)"},
    ],
  },
  ...
  K1: {
    chi: [
      ...
      {t:"認顏色",q:['哪一個和 🔵 一樣顏色？'],o:["🫐","🍎","🍋","🍊"],a:0,g:"🫐 藍莓是藍色！",b:"🔵 藍色 → 🫐"},
      {t:"認顏色",q:['哪一個和 🟠 一樣顏色？'],o:["🍊","🍎","🍋","🫐"],a:0,g:"🍊 橙是橙色！",b:"🟠 橙色 → 🍊"},
      {t:"數一數",q:['🍌🍌🍌🍌 有多少條？'],o:["3","4","5","6"],a:1,g:"四條香蕉 🍌",b:"數一數：4 條。"},
      {t:"數一數",q:['🐤 有多少隻？'],o:["1","2","3","4"],a:0,g:"一隻小雞 🐤",b:"數一數：1 隻。"},
      {t:"找相同",q:['哪一個是 🌸？'],o:["🌸","🌻","🍄","🌿"],a:0,g:"對了，🌸！",b:"找出一樣的 🌸。"},
      {t:"比大小",q:['哪一個最大？'],o:["🐳","🐟","🦐","🐚"],a:0,g:"🐳 鯨魚最大！",b:"🐳 最大。"},
      {t:"找相同",q:['哪一個是 ❤️？'],o:["❤️","⭐","🔺","⬛"],a:0,g:"對了，❤️！",b:"找出一樣的 ❤️。"},
    ],
    eng: [
      ...
      {t:"Colour",q:['Same colour as 🔵 ?'],o:["🫐","🍎","🍋","🍊"],a:0,g:"🫐 is blue!",b:"🔵 → 🫐"},
      {t:"Count",q:['How many? 🍌🍌🍌'],o:["2","3","4","5"],a:1,g:"three 🍌",b:"count: 3"},
      {t:"Match",q:['Find 🐶'],o:["🐶","🐱","🐰","🐭"],a:0,g:"🐶!",b:"find 🐶"},
      {t:"Letter",q:['Find the letter C'],o:["C","G","O","Q"],a:0,g:"This is C!",b:"C"},
      {t:"Big/Small",q:['Which is small?'],o:["🐜","🐘","🐴","🐄"],a:0,g:"🐜 is small!",b:"🐜 small"},
      {t:"Count",q:['How many? 🐤🐤'],o:["1","2","3","4"],a:1,g:"two 🐤🐤",b:"count: 2"},
      {t:"Match",q:['Find ⭐'],o:["⭐","❤️","🔺","⬛"],a:0,g:"⭐!",b:"find ⭐"},
    ],
  },
  ...
  K2: {
    chi: [
      ...
      {t:"數一數",q:['🍰🍰🍰🍰 有多少件？'],o:["3","4","5","6"],a:1,g:"四件蛋糕 🍰",b:"數一數：4 件。"},
      {t:"排規律",q:['🟡🟢🟡🟢 下一個是？'],o:["🟡","🟢","🔴","🔵"],a:0,g:"黃、綠、黃、綠…下一個 🟡",b:"規律：黃綠黃綠黃。"},
      {t:"認顏色",q:['🍊 是甚麼顏色？'],o:["🟠","🔴","🟡","🟢"],a:0,g:"🍊 是橙色！",b:"橙 → 🟠"},
      {t:"比多少",q:['哪一堆最少？'],o:["🐟","🐟🐟","🐟🐟🐟","🐟🐟🐟🐟"],a:0,g:"1 條最少！",b:"最少嗰堆。"},
      {t:"接數字",q:['2, 3, 4, 5, __ ?'],o:["6","7","5","8"],a:0,g:"…5, 6",b:"5 之後是 6。"},
      {t:"找相同",q:['哪一個和 🔺 一樣？'],o:["🔺","⬛","⭐","❤️"],a:0,g:"對了，🔺！",b:"找一樣的 🔺。"},
    ],
    eng: [
      ...
      {t:"Count",q:['How many? 🍰🍰🍰🍰'],o:["3","4","5","6"],a:1,g:"four 🍰",b:"count: 4"},
      {t:"Letter",q:['A  B  C  D  __ ?'],o:["E","F","G","H"],a:0,g:"…D E",b:"after D: E"},
      {t:"Colour",q:['🍊 colour?'],o:["🟠","🔴","🟡","🟢"],a:0,g:"🍊 orange 🟠",b:"orange → 🟠"},
      {t:"Match",q:['Find 🐸'],o:["🐸","🐢","🦎","🐍"],a:0,g:"🐸!",b:"find 🐸"},
      {t:"Pattern",q:['🟡🟢🟡🟢 next?'],o:["🟡","🟢","🔴","🔵"],a:0,g:"…🟡",b:"yellow, green, …"},
      {t:"Letter",q:['Find the letter D'],o:["D","B","P","O"],a:0,g:"This is D!",b:"D"},
    ],
  },
  ...
  K3: {
    chi: [
      ...
      {t:"簡單加法",q:['🍎🍎🍎 加 🍎，一共幾多？'],o:["3","4","5","6"],a:1,g:"3 + 1 = 4 🍎",b:"合起來 4 個。"},
      {t:"簡單減法",q:['🍬🍬🍬 食咗 🍬，剩多少？'],o:["1","2","3","4"],a:1,g:"3 - 1 = 2 🍬🍬",b:"剩返 2 粒。"},
      {t:"接數字",q:['…8, 9, 10, __ ?'],o:["11","12","9","7"],a:0,g:"10 之後是 11",b:"10, 11。"},
      {t:"看圖識字",q:['💧 這是甚麼？寫成哪個字？'],o:["水","木","火","永"],a:0,g:"💧 = 水",b:"這是「水」。"},
      {t:"認字",q:['🔥 是熱的，❄️ 是……？'],o:["冷","熱","暖","大"],a:0,g:"❄️ 是冷的！熱 ↔ 冷",b:"雪是冷的。"},
      {t:"比大小",q:['哪個數字最小？'],o:["1","5","8","3"],a:0,g:"1 最小",b:"1 比其他小。"},
    ],
    eng: [
      ...
      {t:"Phonics",q:['🐷  p _ g'],o:["i","a","o","e"],a:0,g:"p-i-g = pig",b:"pig"},
      {t:"Phonics",q:['🧢  h _ t'],o:["a","e","o","u"],a:0,g:"h-a-t = hat",b:"hat"},
      {t:"Count",q:['How many? ⭐⭐⭐⭐⭐⭐'],o:["5","6","7","8"],a:1,g:"6 ⭐",b:"count: 6"},
      {t:"Letter sound",q:['🐱 starts with?'],o:["c","k","s","a"],a:0,g:"cat → c",b:"c"},
      {t:"Colour",q:['🍓 colour?'],o:["🔴","🟡","🔵","🟢"],a:0,g:"🍓 red 🔴",b:"strawberry → 🔴"},
      {t:"Number",q:['Which is 9?'],o:["9","6","3","1"],a:0,g:"This is 9!",b:"9"},
    ],
  },

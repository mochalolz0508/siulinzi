...
window.QUESTION_BANK = {
  ...
  P2: {
    ...
    eng: [
      ...
      {t:"This/That",q:['___ is my bag. (near me) 🎒'],o:["This","Those","Them","These"],a:0,g:"This (near me)",b:"near → This"},
      {t:"Verb be",q:['They ___ my friends.'],o:["is","am","are","be"],a:2,g:"They are …",b:"They + are"},
      {t:"Plural",q:['one box, two ___'],o:["boxs","boxes","box","boxies"],a:1,g:"box → boxes",b:"box → boxes (+es)"},
      {t:"Preposition",q:['The bird is ___ the tree. 🐦🌳'],o:["in","on","under","of"],a:1,g:"on the tree",b:"on"},
      {t:"Vocabulary",q:['We sleep at ___ 🌙'],o:["morning","night","noon","school"],a:1,g:"sleep at night 🌙",b:"night"},
      {t:"Question",q:['___ old are you?'],o:["How","What","Who","Where"],a:0,g:"How old …",b:"age → How old"},
    ],
  },
  ...
  P4: {
    ...
    eng: [
      ...
      {t:"Past tense",q:['He ___ his homework yesterday.'],o:["do","did","done","does"],a:1,g:"did (past)",b:"past of do → did"},
      {t:"Superlative",q:['This box is the ___ of all. 📦'],o:["heavy","heavier","heaviest","more heavy"],a:2,g:"the heaviest",b:"the + -est"},
      {t:"Adverb",q:['Please speak ___ 🤫'],o:["quiet","quietly","quieter","quietest"],a:1,g:"speak quietly",b:"verb + -ly"},
      {t:"Preposition",q:['The clock is ___ the wall. 🕐'],o:["on","in","at","to"],a:0,g:"on the wall",b:"on"},
      {t:"Vocabulary",q:['A person who cooks in a restaurant is a ___'],o:["chef","teacher","nurse","pilot"],a:0,g:"chef 👨‍🍳",b:"cooks → chef"},
      {t:"Question",q:['___ book is this? — It is mine.'],o:["Whose","Who","What","Where"],a:0,g:"Whose → mine",b:"belong → Whose"},
    ],
  },
  ...
  P5: {
    ...
    eng: [
      ...
      {t:"Present perfect",q:['They ___ never been to Japan.'],o:["have","has","had","having"],a:0,g:"They have never …",b:"They + have"},
      {t:"Irregular past",q:['I ___ my keys yesterday. 🔑'],o:["lose","lost","losed","loses"],a:1,g:"lose → lost",b:"past of lose → lost"},
      {t:"Adverb of frequency",q:['I ___ brush my teeth. (every day)'],o:["always","never","seldom","hardly"],a:0,g:"always (every day)",b:"every day → always"},
      {t:"Conjunction",q:['Work hard, ___ you will succeed.'],o:["and","but","or","nor"],a:0,g:"…, and you will succeed",b:"result → and"},
      {t:"Vocabulary",q:['Very big = ___'],o:["huge","tiny","short","thin"],a:0,g:"huge",b:"very big → huge"},
      {t:"Comparative",q:['Tom is the ___ boy in class.'],o:["tall","taller","tallest","more tall"],a:2,g:"the tallest",b:"the + -est"},
    ],
  },
  ...
  P6: {
    ...
    eng: [
      ...
      {t:"Conditional",q:['If I ___ rich, I would travel the world.'],o:["were","am","will be","being"],a:0,g:"If I were rich … (unreal)",b:"unreal → were"},
      {t:"Passive",q:['English ___ spoken all over the world.'],o:["is","does","have","being"],a:0,g:"is spoken (passive)",b:"is + past participle"},
      {t:"Idiom",q:['“Break a leg!” means…'],o:["Good luck!","Get hurt","Run away","Sit down"],a:0,g:"= Good luck! 🍀",b:"idiom: good luck"},
      {t:"Reported speech",q:['She asked ___ I was okay.'],o:["if","that","what","for"],a:0,g:"asked if …",b:"yes/no report → if"},
      {t:"Conjunction",q:['___ the rain, we still went out. 🌧️'],o:["Despite","Because","So","Unless"],a:0,g:"Despite the rain (+ noun)",b:"Despite + noun"},
      {t:"Vocabulary",q:['Something you must do is ___'],o:["necessary","lazy","funny","empty"],a:0,g:"necessary",b:"must do → necessary"},
    ],
  },
